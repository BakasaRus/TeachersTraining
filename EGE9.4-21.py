def play(x, y, move):
    ...
    if move % 2 == 0:
        # Ходит Петя, он должен проиграть, не поддаваясь
        return m1 and m2 and m3 and m4
    else:
        # Ходит Ваня, он должен выиграть
...
def play2(x, y, move):
    ...
    m1 = play2(x + 1, y, move + 1)
    m2 = play2(x * 2, y, move + 1)
    m3 = play2(x, y + 1, move + 1)
    m4 = play2(x, y * 2, move + 1)
...
for s in range(1, 69 + 1):
    if play(7, s, 0) and not play2(7, s, 0):
        print(s)
